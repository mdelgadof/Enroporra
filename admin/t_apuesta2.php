...
EOT;
	...
	function fichaEliminatoria($id_partido) {
		...
		global $conexion,$arrayEliminatorias,$ROTULOS_ELIMINATORIAS;
		...
		$content = "<span class='red'><b>".$id_partido."</b></span> ".$ROTULOS_ELIMINATORIAS[$arra["fase"]]."<br>".date("d/m/Y H:i",strtotime($arra["fecha"]." ".$arra["hora"]))."<br>";
		$content.= "<table>";
	...
	echo "
		<table align='center'>
			<form name='fase2' method='post' action='apuesta2.php' onSubmit='return revisaForm();'>
