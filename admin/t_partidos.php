...
?>
		...
		<input type='hidden' name='accion' value='insertar'>
			<h1 class='red'>Resultados reales</h1>
                <p>Aquí escribimos los resultados y goleadores que se vayan produciendo en la realidad durante <?= $NOMBRE_TORNEO ?>. Esto nos permitirá tener actualizada la home con los últimos partidos y a la vez permitirá que la clasificación se vaya generando automáticamente. Por motivos obvios, el sistema no deja introducir el resultado de un partido que todavía no se ha jugado (o lo que es lo mismo, tiene fecha futura).</p>
<?
